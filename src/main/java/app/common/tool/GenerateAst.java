...
public class GenerateAst {
    public static void main(String[] args) throws IOException {
        ...
        defineAst(outputDir, "Expr", Arrays.asList("Assign:Token name,Expr value",
                ...
                "Super:Token keyword,Token method", "Grouping:Expr expression", "Literal:Object value",
                "Logical:Expr left,Token operator,Expr right", "This:Token keyword", "Unary:Token operator,Expr right",
                "Variable:Token name", "Function:List<Token> params,List<Stmt> body"));
        ...
        defineAst(outputDir, "Stmt", Arrays.asList("Block:List<Stmt> statements",
                ...
                "If:Expr condition,Stmt thenBranch,Stmt elseBranch", "Return:Token keyword,Expr value",
    ...
    private static void defineAst(String outputDir, String baseName, List<String> types) throws IOException {
        ...
        writer.println("package app.common.lox;");
        writer.println();
